...
### Experimenting with Different Types of Graphs 
```{r}
...
#Filtering the male gender out of the new data frame to find the average 
snow_female <- snow_tidy %>%  
  filter(sex %in% c ("f", "F"))

#Finding the average of the snowshoe female population from 1999-2012 in Bonanza Creek 

snowfemalemean <- mean(snow_female$weight, na.rm = TRUE)
#The average weight for snowshoe females in the data frame is 1289.994g 

#Filtering the female gender out of the new data frame to find the average 
snow_male <- snow_tidy %>%  
  filter(sex %in%c ("m", "M"))

#Finding the average of the snowshoe male population from 1999-2012 in Bonaza Creek 

snowmalemean <- mean(snow_male$weight, na.rm = TRUE)
#The average weight for snowshoe males in the data frame is 1344.408g 
```
...
```{r}
#Creating a histogram based on weight 
